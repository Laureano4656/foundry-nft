...
# Deploy Targets (Using One-Liner syntax to avoid Tab issues)
...
zkdeploy :; @forge create src/OurToken.sol:OurToken --rpc-url http://127.0.0.1:8011 --private-key $(DEFAULT_ZKSYNC_LOCAL_KEY) --legacy --zksync